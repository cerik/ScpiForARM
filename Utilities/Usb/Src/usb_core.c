...
void DataStageIn(void)
{
  ...
  UserToPMABufferCopy(DataBuffer,ENDP0,GetEPTxAddr(ENDP0), Length);
...
void Data_Setup0(void)
{
  ...
  if (Request_No == GET_DESCRIPTOR)//6
  {
    if (Type_Recipient == (STANDARD_REQUEST | DEVICE_RECIPIENT))
    {
  ...
  /*GET CONFIGURATION*/
  else if (Request_No == GET_CONFIGURATION)//8
  {
    if (Type_Recipient == (STANDARD_REQUEST | DEVICE_RECIPIENT))
    {
  ...
  /*GET INTERFACE*/
  else if (Request_No == GET_INTERFACE)//10
  {
